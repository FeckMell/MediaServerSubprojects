...
public:
	...
	int open_output_file2(const char *filename, AVFormatContext **input_format_context, AVCodecContext *input_codec_context,
	...
	//int CRTPReceive::sdp_openAVIO(AVFormatContext **pctx, const char *data, AVDictionary **options, AVIOContext *output_io_context);



	void CRTPReceive::do_receive(int my_port);
